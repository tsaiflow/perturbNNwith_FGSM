...
x_new1 = np.load('./checkpoints/x_new1.npy')
x_new5 = np.load('./checkpoints/x_new5.npy')
x_new10 = np.load('./checkpoints/x_new10.npy')
x_new20 = np.load('./checkpoints/x_new20.npy')
x_new30 = np.load('./checkpoints/x_new30.npy')
x_new40 = np.load('./checkpoints/x_new40.npy')
x_new50 = np.load('./checkpoints/x_new50.npy')
...
#     plt.imsave('./images/part1/eps1_'+str(i)+'.png', x_new1[i].reshape((28,28)))
#     plt.imsave('./images/part1/eps5_'+str(i)+'.png', x_new5[i].reshape((28,28)))
#     plt.imsave('./images/part1/eps10_'+str(i)+'.png', x_new10[i].reshape((28,28)))
#     plt.imsave('./images/part1/eps20_'+str(i)+'.png', x_new20[i].reshape((28,28)))
#     plt.imsave('./images/part1/eps30_'+str(i)+'.png', x_new30[i].reshape((28,28)))
#     plt.imsave('./images/part1/eps40_'+str(i)+'.png', x_new40[i].reshape((28,28)))
#     plt.imsave('./images/part1/eps50_'+str(i)+'.png', x_new50[i].reshape((28,28)))